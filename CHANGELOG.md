...
## [0.1.2](https://github.com/alexrudy/pidfile/compare/v0.1.1...v0.1.2) - 2026-09-13

### Other

- Merge pull request #38 from alexrudy/dependabot/cargo/tracing-0.1.44
- *(deps)* bump tracing from 0.1.41 to 0.1.44
- Fix IO error
- *(deps)* bump tempfile from 3.15.0 to 3.19.1
- *(deps)* bump libc from 0.2.169 to 0.2.172
- *(deps)* bump tempfile from 3.14.0 to 3.15.0
- *(deps)* bump libc from 0.2.159 to 0.2.169
